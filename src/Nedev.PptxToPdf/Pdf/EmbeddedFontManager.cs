...
public class EmbeddedFontManager
{
    ...
    private string? GetSystemFontPath(string fontName)
    {
        ...
        if (fontName.Contains("榛戜綋") || fontName.Contains("SimHei"))
            return @"C:\Windows\Fonts\simhei.ttf";
        if (fontName.Contains("妤蜂綋") || fontName.Contains("SimKai"))
            return @"C:\Windows\Fonts\simkai.ttf";
        if (fontName.Contains("浠垮畫") || fontName.Contains("SimFang"))
            return @"C:\Windows\Fonts\simfang.ttf";
        if (fontName.Contains("瀹嬩綋") || fontName.Contains("SimSun"))
