...
public class PdfRenderer
{
    ...
    private PdfFont GetOrCreateFont(string fontName, PdfPage? page = null, bool isChinese = false)
    {
        ...
        if (isChinese || fontName.Contains("瀹嬩綋") || fontName.Contains("SimSun") || fontName.Contains("STSong") || fontName.Contains("寰蒋闆呴粦") || fontName.Contains("Microsoft YaHei") || fontName.Contains("榛戜綋") || fontName.Contains("SimHei"))
        {
    ...
    private Color InterpolateGradientColor(List<Nedev.PptxToPdf.GradientStop> stops, double position)
    {
        // Find the two stops that bracket the position
        Nedev.PptxToPdf.GradientStop? lower = null;
        Nedev.PptxToPdf.GradientStop? upper = null;
