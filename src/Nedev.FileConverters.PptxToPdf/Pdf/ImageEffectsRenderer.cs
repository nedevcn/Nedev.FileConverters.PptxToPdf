...
public class ImageEffectsRenderer
{
    ...
    // ---------------------------------------------------------------------------
    //  Public entry point ??call this before rendering the shape itself
    // ---------------------------------------------------------------------------
        ...
        double radius, ShapeType shapeType)
    {
        ...
        for (int i = strips - 1; i >= 0; i--)
        {
            ...
            double alpha = t * t * 0.85; // 0 at edge ??higher inward
        ...
        ReflectionEffect reflection, ShapeType shapeType)
    {
        ...
        // OOXML reflection has startOpacity (top of reflection) ??endOpacity (bottom).
        ...
        for (int i = 0; i < strips; i++)
        {
            ...
            double sy = reflY + reflHeight - stripH * (i + 1); // bottom ??top in PDF
...
// ---------------------------------------------------------------------------
//  PDF ExtGState object ??represents a Graphics State with alpha transparency
// ---------------------------------------------------------------------------
